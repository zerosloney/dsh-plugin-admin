...
var CSS_TEXT = [
  ...
  '[data-dsh-admin-section] .search-wrap { flex: 2.2; gap: 6px; }',
  '[data-dsh-admin-section] .search-wrap .input { flex: 1; min-width: 0; }',
  '[data-dsh-admin-section] .install-wrap { flex: 1; }',
...
function renderPluginsView(view, patch, install, remove, checkUpdates, upgrade) {
  ...
  elements.push(createElement('div', { className: 'toolbar', key: 'toolbar' },
    createElement('div', { className: 'input-wrap search-wrap', key: 'search-wrap' },
