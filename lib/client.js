...
// and falls back to IconSettingsOutline16), so this plugin's nine pages
...
function apply(ctx) {
  ...
  // Eleven surfaces, each parked where the shell already renders its domain.
  // 插件管理 joins the shell-owned 插件 section as its third tab (插件配置 0,
  // 插件列表 10, 扩展插件 20); MCP / 子智能体 / 命令与钩子 / 历史会话 / 工作区 /
  // 技能 / Web 搜索 / 用量仪表盘 / Webhook 触发 become standalone settings pages
  // (MCP服务器 takes the 25 slot right after Agent 预设, 子智能体 follows at 26,
  // 命令与钩子 at 27, 历史会话 sorts last).
