 ...
 * Shared by storageAdmin / webSearchAdmin / agentPresetsAdmin (formerly three
 * divergent local copies whose span overran into subsequent `- insert:`
 * blocks and whose raw-text id match missed quoted/commented rows).
 * @param {string[]} lines - patch file lines.
