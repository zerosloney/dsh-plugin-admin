...
**npm:** [`dsh-plugin-admin`](https://www.npmjs.com/package/dsh-plugin-admin) · v1.20.0 · MIT
...
| Plugin | dsh | Status |
|---|---|---|
| v1.20.0 | **0.1.5-rc.2** (`latest` tag, verified baseline) | ✅ full; no official 已归档会话 page → 历史会话 / 工作区 fall back to their own rows |
| v1.20.0 | **0.1.6-alpha.2** (`alpha` tag, newest published) | ✅ full (`unarchiveSession` + the official 已归档会话 page the session-history panel merges into) |
